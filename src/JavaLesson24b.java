...
public class JavaLesson24b extends JFrame{
		...
		private class ListenForButton implements ActionListener{
			...
			public void actionPerformed(ActionEvent e){
				...
				if(e.getSource() == button1){
					...
					JOptionPane.showMessageDialog(JavaLesson24b.this, infoOnComponent, "Information", JOptionPane.INFORMATION_MESSAGE);
