...
public class JavaLesson25b extends JFrame{
		...
		private class ListenForButton implements ActionListener{
			...
			public void actionPerformed(ActionEvent e){
				...
				if(e.getSource() == button1){
					...
					JOptionPane.showMessageDialog(JavaLesson25b.this, infoOnComponent, "Information", JOptionPane.INFORMATION_MESSAGE);
