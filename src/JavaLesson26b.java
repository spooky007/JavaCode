...
public class JavaLesson26b extends JFrame{
	...
	private class ListenForButton implements ActionListener{
		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource() == button1){
				...
				JOptionPane.showMessageDialog(JavaLesson26b.this, outputString, "Information", JOptionPane.INFORMATION_MESSAGE);
