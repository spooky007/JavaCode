...
public class JavaLesson27b extends JFrame{
	...
	private class ListenForButton implements ActionListener{
		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource() == button1){
				...
				JOptionPane.showMessageDialog(JavaLesson27b.this, outputString, "Information", JOptionPane.INFORMATION_MESSAGE);
